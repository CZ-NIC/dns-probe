...
DDP::ConfigSysrepo::ConfigSysrepo(Config& cfg) : PollAble(), m_cfg(cfg), m_path_map{
        ...
        {SYSCONF_CFG_ROOT "/tcp/concurrent-connections",         m_cfg.tcp_ct_size},
        {SYSCONF_CFG_ROOT "/tcp/timeout",                        m_cfg.tcp_ct_timeout},
        {SYSCONF_CFG_ROOT "/pcap-export/file-name-prefix",       m_cfg.pcap_prefix},
        {SYSCONF_CFG_ROOT "/pcap-export/timeout",                m_cfg.pcap_rot_timeout},
        {SYSCONF_CFG_ROOT "/pcap-export/file-size-limit",        m_cfg.pcap_rot_size},
        {SYSCONF_CFG_ROOT "/pcap-export/selection",              m_cfg.pcap_export},
