...
if (DPDK_FOUND)
    ...
    set_property(TARGET DPDK::DPDK PROPERTY INTERFACE_COMPILE_DEFINITIONS ${DPDK_DEFINITIONS})
    set_property(TARGET DPDK::DPDK PROPERTY INTERFACE_COMPILE_OPTIONS ${DPDK_CFLAGS})
endif()
